                ...
                <div class="panel-heading">
                  <h4>
                    ...
                    <button type="button" class="btn btn-success"
                      onclick="location.href='load-adminaddstuinfo?selectedparam=${tablekey}'">Add
                    Information</button>
                    </span>
                  </h4>
                </div>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="table-responsive">
                      <table id="example"
                        ...
                        <c:choose>
                          <c:when
                            test="${tablekey == 'global_postedbyadmin_jobs' or tablekey == 'global_refpost_jobs' or tablekey == 'global_jobconsult_jobs'}">
                            <thead>
                              <tr>
                                <th>#</th>
                                <th>Job Title</th>
                             ...
                             <tbody>
                              <c:forEach items="${alistdata}" var="listdata"
                                varStatus="loop">
                                <tr>
                                  <td>${loop.index+1}</td>
