...
<head>
  ...
  <link href="${pageContext.request.contextPath}/theme/userhome/css/main.css" rel="stylesheet">
...
<div class="heading">
<h1 class="section-title">Job Categories</h1>
<h4 class="sub-title">Find the best jobs</h4>
</div>
</div>
