  ...
  <%--   <!--==========================
      ...
      <div class="container">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/theme/userhome/img/about-mission.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/theme/userhome/img/about-plan.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="${pageContext.request.contextPath}/theme/userhome/img/about-vision.jpg" alt="" class="img-fluid">
    ...
    <section id="facts"  class="wow fadeIn">
      <div class="container">
        ...
        <div class="facts-img">
          <img src="${pageContext.request.contextPath}/theme/userhome/img/facts-img.png" alt="" class="img-fluid">
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app1.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app1.jpg" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web3.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web3.jpg" class="link-preview" data-lightbox="portfolio" data-title="Web 3" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app2.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app2.jpg" class="link-preview" data-lightbox="portfolio" data-title="App 2" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card2.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card2.jpg" class="link-preview" data-lightbox="portfolio" data-title="Card 2" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web2.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web2.jpg" class="link-preview" data-lightbox="portfolio" data-title="Web 2" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app3.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/app3.jpg" class="link-preview" data-lightbox="portfolio" data-title="App 3" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card1.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card1.jpg" class="link-preview" data-lightbox="portfolio" data-title="Card 1" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card3.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/card3.jpg" class="link-preview" data-lightbox="portfolio" data-title="Card 3" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web1.jpg" class="img-fluid" alt="">
                <a href="${pageContext.request.contextPath}/theme/userhome/img/portfolio/web1.jpg" class="link-preview" data-lightbox="portfolio" data-title="Web 1" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
