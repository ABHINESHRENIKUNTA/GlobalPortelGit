...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Jobs Posted By Admin</title>
        ...
        <div class="container-fluid">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Jobs Posted By Admin Links</li>
            </ol>
          </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-solid box-primary">
                <div class="box-header">
                  <h3 class="box-title">Jobs Posted By Admin Links</h3> <code>Find your best job..</code>
