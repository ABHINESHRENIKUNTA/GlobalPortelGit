...
<meta charset="UTF-8">
<title><spring:eval
		expression="@viewPropertyConfigurer.getProperty('postedbyadmin.jobs')" /></title>
...
<body
	class="<spring:eval expression="@viewPropertyConfigurer.getProperty('topmenu.color')" /> layout-top-nav">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<section class="content-header">
					<h1>
						Find your link <small>There is a way to do it
							better...find it</small>
					</h1>
					<!--  <ol class="breadcrumb">
              ...
              <li class="active">Employer Posted Job Links</li>
				...
				<section class="content">
					<div class="col-md-12">
						<!-- Primary box -->
						<div
							class="box box-solid box-<spring:eval expression="@viewPropertyConfigurer.getProperty('box.header.color')" />">
							<div class="box-header">
								<h3 class="box-title">
									<spring:eval
										expression="@viewPropertyConfigurer.getProperty('postedbyadmin.jobs')" />
								</h3>
								<code>Find your best job..</code>
								<div class="box-tools pull-right">
									<button
										class="btn btn-<spring:eval expression="@viewPropertyConfigurer.getProperty('box.header.color')" /> btn-sm"
										title="BACK" onclick="location.href='load-jobcategories'">
								...
								<div class="row">
									<div class="col-md-3">
										<a href="#" class="btn btn-primary btn-block margin-bottom"
											onclick="location.href='view-userpostedbyadmin'">Clear
											Filters</a>
										<form:form action="view-userpostedbyadmin" id="industryform"
											commandName="filterdetails">
													...
													<div class="widget">
														...
														<ul class="optionlist">
															<c:forEach items="${industryList}" var="industrydata">
																<li><c:choose>
																		<c:when
																			test="${industrydataval eq industrydata.jobid}">
										...
										<div class="box box-primary">
											...
											<div class="box-body no-padding">
												<ul class="searchList" id="content">
													...
													<!-- job start -->
													<c:forEach items="${listData}" var="jobDetails"
														varStatus="loop">
														<li class="content-result">
															<div class="row">
																<div class="col-md-8 col-sm-8">
																	<div class="jobimg">
																		<i class="fa fa-black-tie fa-5x" aria-hidden="true"
																	...
																	<div class="jobinfo">
																		...
																		<div class="location">
																			<label class="fulltime">${jobDetails.jobtype}</label>
																...
																<div class="col-md-4 col-sm-4">
																	<form action="view-userpostedbyadminid">
																		...
																		<input type="hidden" name="rowid"
																			value="${jobDetails.rowid}" />
																	</form>
																</div>
															</div>
															<p
																style="white-space: nowrap; width: 99%; overflow: hidden; text-overflow: ellipsis;">${jobDetails.skillreq}</p>
														</li>
													</c:forEach>
													<!-- job end -->
												</ul>
