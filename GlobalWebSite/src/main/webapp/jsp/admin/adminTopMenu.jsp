       ...
       <%--  <li class="dropdown menu-merge">
                    ...
                    <div class="tab-content br-n pn">
                      ...
                      <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                        <ul class="media-list" role="menu">
                          <li class="media">
                            <a class="media-left" href="#"> <img src="${pageContext.request.contextPath}/theme/assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="${pageContext.request.contextPath}/theme/assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="${pageContext.request.contextPath}/theme/assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="${pageContext.request.contextPath}/theme/assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading mv5">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
          	<img src="${pageContext.request.contextPath}/theme/assets/img/avatars/admin1.jpg" alt="avatar" class="mw30 br64">
          	<span class="hidden-xs pl15"> <%=session.getAttribute("username")%> </span>
