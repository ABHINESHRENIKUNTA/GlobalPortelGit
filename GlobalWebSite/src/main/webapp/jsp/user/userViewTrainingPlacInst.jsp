...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Training & Placement Institutions</title>
        ...
        <div class="container-fluid">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Training & Placement Institutions Links</li>
            </ol>
          </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-solid box-primary">
                <div class="box-header">
                  <h3 class="box-title">Training & Placement Institutions Links</h3> <code>Find your best job..</code>
