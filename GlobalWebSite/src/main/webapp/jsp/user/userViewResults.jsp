...
<html>
  <head>
    <meta charset="UTF-8">
    <title><spring:eval expression="@viewPropertyConfigurer.getProperty('results')" /></title>
        ...
        <div class="container-fluid">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><spring:eval expression="@viewPropertyConfigurer.getProperty('results')" /></li>
            </ol>
          </section>
           ...
           <div class="col-md-12">
              ...
              <div class="box box-solid box-<spring:eval expression="@viewPropertyConfigurer.getProperty('box.header.color')" />" >
                <div class="box-header">
                  <h3 class="box-title"><spring:eval expression="@viewPropertyConfigurer.getProperty('results')"/> Links</h3> <code>Browse Jobs by Companies..</code>
                  ...
                  <section id="main_content" class="inner">
                  	...
                  	<c:forEach items="${jobsList}" var="resultdata">
                  	
                  	 
					<li class="col-sm-12"><a href='${resultdata.linkaddress}' target="_blank">${resultdata.comments}<br>${resultdata.linkname}</a>
