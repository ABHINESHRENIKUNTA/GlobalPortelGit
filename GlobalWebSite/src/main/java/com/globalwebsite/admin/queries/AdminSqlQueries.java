...
public class AdminSqlQueries {
	...
	public static final String UPLOADADMINCOMPANYLOGODATA_QUERY = "insert into global_company_logos(image_title,file_name,file_link,created_date,modified_date) values(?,?,?,?,?) ";
	public static final String GETADMINDELETEUSERIMAGES_QUERY = "select * from global_userdashb_images";
	public static final String GETADMINDELETECOMPANYLOGOS_QUERY = "select * from global_company_logos";
	...
	public static final String DELETEADMINSELECTEDCOMPANYLOGO_QUERY = "delete from global_company_logos where id=?";
